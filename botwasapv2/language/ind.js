...
exports.groupo = () => {
	return`*「PERINTAH INI HANYA DAPAT DIGUNAKAN DI GROUP」*`
}
...
exports.admin = () => {
	return`*「PERINTAH INI HANYA DAPAT DIGUNAKAN OLEH ADMIN GROUP」*`
}

exports.badmin = () => {
	return`*「JADIIN ADMIN DULU BOT NYA:)」*`
}
...
exports.clears = () => {
	return`*oke semua chat sudah di bersihkan*`
}
